 ...
 const DEFAULT_IMAGES = [
   ...
   { src: gallery2, alt: 'Premium boat console with magenta accent lighting' },
   { src: gallery3, alt: 'Aerial view of speedboat cutting through blue water' },
   { src: gallery4, alt: 'Luxury yacht interior with premium seating' },
   { src: gallery5, alt: 'Yacht silhouette against dramatic sunset sky' },
   { src: gallery6, alt: 'Boat bow detail with rope and metal fittings' },
   { src: gallery7, alt: 'Friends enjoying luxury boat ride at golden hour' },
 ];
 ...
 function buildItems(pool: ImageItem[] | string[], seg: number): BuildItem[] {
 ...
 export default function DomeGallery({
   ...
   useGesture(
     {
       onDragStart: ({ event }) => {
         ...
         const potential = target.closest?.('.item__image') as HTMLElement;
   ...
   }, [segments, lockScroll, unlockScroll, enlargeTransitionMs, openedImageBorderRadius, openedImageWidth, openedImageHeight, grayscale]);
